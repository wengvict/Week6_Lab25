...
Item name: <input type="text" name="name" value="name"> <br> <br>
Item description: <input type="text" name="description" value="description"> <br><br>
Item quantity: <input type="number" name="quantity" value="quantity"> <br><br>
Item price: <input type="double" name="price" value="price"> <br><br>
